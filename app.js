...
form.addEventListener('submit', function (e) {
	// will refresh if I don't prevent the default behavior, and console log will disappear
	e.preventDefault();
	// amount.value will be a string, thus will need to be converted to an integer
